...
var AuthController = (function () {
    ...
    AuthController.prototype.login = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var loginDto, errors, _a, status, message, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        loginDto = (0, class_transformer_1.plainToClass)(auth_dto_1.LoginDto, req.body);
                        return [4, (0, class_validator_1.validate)(loginDto)];
                    case 1:
                        errors = _b.sent();
                        if (errors.length > 0) {
                            return [2, res.status(400).json({ errors: errors })];
                        }
                        return [4, this.authService.asigToken(loginDto)];
                    case 2:
