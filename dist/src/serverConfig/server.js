...
var permission_service_1 = require("./../api/permission/permission.service");
var express = require("express");
var data_source_1 = require("../data/database-config/data-source");
var errorHandler_1 = require("../data/middlewares/inertceptor/errorHandler");
var Server = (function () {
    function Server() {
        this.app = express();
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                data_source_1.AppDataSource.initialize()
                    ...
                    return __generator(this, function (_a) {
                        permissionServices = new permission_service_1.PermissionServices();
                        permissionServices.syncPermissions();
                        this.app.listen(options.port, function () {
                            console.log("Server running on port ".concat(options.port));
                        });
